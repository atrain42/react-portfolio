...
function App() {
  ...
  const writings = [
    ...
    },
    {
      ...
      contentthree:
        "After you have a lot of JavaScript projects, something will click. You will suddenly know how to write JavaScript and you will realize that all JavaScript is, is objects. At this point, I then recommend going back and diving into the theory of JavaScript. Look at concepts like the call stack, event loop, hoisting, and dig deep into understanding what exactly the DOM is. After you have a ton of projects under your belt and you see how different things are done, once you learn the theory, you begin to understand why things were done the way they were.",
      contentfour:
